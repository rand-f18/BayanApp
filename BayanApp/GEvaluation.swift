...
struct GEvaluationContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            // Display the target letter "ج" in a larger font
            Text("ج")
            ...
            // User guidance
            Text("تأكد من نطق حرف الجيم بوضوح.")
                .font(.subheadline)
...
class GAudioRecorder: NSObject, AVAudioRecorderDelegate, ObservableObject {
